...
modify_image_kmeans <- function(image_array, num_clusters, num_pixels_to_modify) {
...
# Read number of pixels to modify from user
num_pixels_to_modify <- as.integer(readline(prompt = "Enter the number of pixels to modify: "))
...
for (file_name in file_list) {
  ...
  modified_image_array <- modify_image_kmeans(image_array, num_clusters, num_pixels_to_modify)
